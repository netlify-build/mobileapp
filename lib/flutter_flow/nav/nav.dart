...
class AppStateNotifier extends ChangeNotifier {
  NetlifyFirebaseUser? initialUser;
  NetlifyFirebaseUser? user;
  ...
  void update(NetlifyFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'PlayNow',
              path: 'playNow',
              builder: (context, params) => PlayNowWidget(),
            ),
            FFRoute(
              name: 'AllMovie_Full',
              path: 'allMovieFull',
              builder: (context, params) => AllMovieFullWidget(),
            )
